...
const props = defineProps({
  coverLoading: { type: Boolean, required: true },
  GameBeginSetConfigOpen: { type: Boolean, required: true },
});
const emits = defineEmits([
  'update:GameBeginSetConfigOpen',
]);
const openApplyAllocation = () => {
  emits('update:GameBeginSetConfigOpen', true);
};
</script>
